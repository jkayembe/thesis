...
/***/ 661:
/*!***************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./src/components/restore-backup/BackupRestore.css ***!
  \***************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!*************************************************************************!*\
  !*** ./src/components/restore-backup/backupRestoreRoot.js + 15 modules ***!
  \*************************************************************************/
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./src/components/restore-backup/BackupRestore.css
var BackupRestore = __webpack_require__(661);
...
var BackupRestore_options = {};

BackupRestore_options.styleTagTransform = (styleTagTransform_default());
BackupRestore_options.setAttributes = (setAttributesWithoutAttributes_default());
BackupRestore_options.insert = insertBySelector_default().bind(null, "head");
BackupRestore_options.domAPI = (styleDomAPI_default());
BackupRestore_options.insertStyleElement = (insertStyleElement_default());

var BackupRestore_update = injectStylesIntoStyleTag_default()(BackupRestore/* default */.A, BackupRestore_options);




       /* harmony default export */ const restore_backup_BackupRestore = (BackupRestore/* default */.A && BackupRestore/* default */.A.locals ? BackupRestore/* default */.A.locals : undefined);

;// ./src/components/restore-backup/BackupRestore.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class BackupRestore_BackupRestore extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      password: false,
  ...
  render() {
    ...
    }, this.state.password !== false ? /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement("h4", {
      className: "mb-2"
    }, map.restore_password_dialog_headline), /*#__PURE__*/external_React_default().createElement("input", {
    ...
    }, map.restore_password_dialog_button)) : /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement("h4", {
      className: "mb-2"
    }, map.restore_backup_dialog_headline), /*#__PURE__*/external_React_default().createElement("div", {
    ...
    }, map.restore_backup_dialog_button)))))), this.state.terminate && /*#__PURE__*/external_React_default().createElement(Terminate_Terminate, null));
  }
}
BackupRestore_BackupRestore.propTypes = {
  id: (prop_types_default()).string
};
;// ./src/components/restore-backup/backupRestoreRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(BackupRestore_BackupRestore, {
    id: id
