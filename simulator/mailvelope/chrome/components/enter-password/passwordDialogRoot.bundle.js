...
"use strict";
/*!**************************************************************************!*\
  !*** ./src/components/enter-password/passwordDialogRoot.js + 16 modules ***!
  \**************************************************************************/
...
;// ./src/components/enter-password/PasswordDialog.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class PasswordDialog extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      keyId: '',
  ...
  render() {
    return /*#__PURE__*/external_React_default().createElement(SecurityBG_SecurityBG, {
    ...
    }, map.pwd_dialog_header)), /*#__PURE__*/external_React_default().createElement("div", {
      className: "modal-body overflow-auto py-0 px-4"
    }, /*#__PURE__*/external_React_default().createElement(Alert, {
      type: "info",
      className: "d-flex align-items-center overflow-hidden pl-2"
    }, /*#__PURE__*/external_React_default().createElement("span", {
      className: "icon icon-key lead text-info mr-2"
    }), /*#__PURE__*/external_React_default().createElement("div", null, /*#__PURE__*/external_React_default().createElement("b", null, this.state.userId), /*#__PURE__*/external_React_default().createElement("br", null), this.state.keyId)), this.state.reason && /*#__PURE__*/external_React_default().createElement("p", null, this.state.reason), /*#__PURE__*/external_React_default().createElement("div", {
    ...
    }, map.pwd_dialog_wrong_pwd)), /*#__PURE__*/external_React_default().createElement("div", null, /*#__PURE__*/external_React_default().createElement("div", {
      ...
      htmlFor: "remember"
    }, map.pwd_dialog_cache_pwd)))), /*#__PURE__*/external_React_default().createElement("div", {
    ...
    }, map.form_cancel), /*#__PURE__*/external_React_default().createElement("button", {
      type: "button",
      onClick: this.handleConfirm,
      disabled: this.state.showError,
      className: "btn btn-primary"
    }, map.form_ok))))))), this.state.timeout && /*#__PURE__*/external_React_default().createElement(Timeout_Timeout, null));
  }
}
PasswordDialog.propTypes = {
  id: (prop_types_default()).string
};
;// ./src/components/enter-password/passwordDialogRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  addDocumentTitle(`Mailvelope - ${map.pwd_dialog_header}`);
  // component used as a container (client API)
  const root = document.createElement('div');
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(PasswordDialog, {
    id: id
