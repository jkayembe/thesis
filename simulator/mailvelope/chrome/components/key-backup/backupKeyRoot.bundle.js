...
"use strict";
/*!*****************************************************************!*\
  !*** ./src/components/key-backup/backupKeyRoot.js + 16 modules ***!
  \*****************************************************************/
...
;// ./src/components/key-backup/BackupKey.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class BackupKey extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      waiting: false,
  ...
  render() {
    ...
    }, map.keybackup_waiting_headline), /*#__PURE__*/external_React_default().createElement("p", {
      className: "align-self-center text-center"
    }, map.keybackup_waiting_description)) : /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement("h4", {
      className: "mb-4"
    }, map[`keybackup_${this.state.action}_dialog_headline`]), /*#__PURE__*/external_React_default().createElement("p", null, map[`keybackup_${this.state.action}_dialog_description`]), /*#__PURE__*/external_React_default().createElement("ul", null, /*#__PURE__*/external_React_default().createElement("li", null, map[`keybackup_${this.state.action}_dialog_list_1`]), /*#__PURE__*/external_React_default().createElement("li", null, map[`keybackup_${this.state.action}_dialog_list_2`])), this.state.error && /*#__PURE__*/external_React_default().createElement(Alert, {
      type: "danger"
    }, this.state.error.message), /*#__PURE__*/external_React_default().createElement("button", {
      type: "button",
      onClick: this.handleClick,
      className: "btn btn-primary align-self-end"
    }, map[`keybackup_${this.state.action}_dialog_button`])))))), this.state.terminate && /*#__PURE__*/external_React_default().createElement(Terminate_Terminate, null));
  }
}
BackupKey.propTypes = {
  id: (prop_types_default()).string
};
;// ./src/components/key-backup/backupKeyRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(BackupKey, {
    id: id
