...
/***/ 986:
/*!***************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[2].use[2]!./src/components/util/Timeout.scss ***!
  \***************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.timeout{position:fixed;z-index:1050}.timeout .backdrop{display:block;position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,0.8)}.timeout>.symbol{font-size:8em;color:#fff;opacity:0.85;width:100%;height:100%;position:fixed;display:flex;justify-content:center;align-items:center}
`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
"use strict";
/*!*****************************************************************!*\
  !*** ./src/components/import-key/importKeyRoot.js + 16 modules ***!
  \*****************************************************************/
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[2].use[2]!./src/components/util/Timeout.scss
var Timeout = __webpack_require__(986);
;// ./src/components/util/Timeout.scss
...
Timeout_options.styleTagTransform = (styleTagTransform_default());
Timeout_options.setAttributes = (setAttributesWithoutAttributes_default());
Timeout_options.insert = insertBySelector_default().bind(null, "head");
Timeout_options.domAPI = (styleDomAPI_default());
Timeout_options.insertStyleElement = (insertStyleElement_default());

var Timeout_update = injectStylesIntoStyleTag_default()(Timeout/* default */.A, Timeout_options);




       /* harmony default export */ const util_Timeout = (Timeout/* default */.A && Timeout/* default */.A.locals ? Timeout/* default */.A.locals : undefined);

;// ./src/components/util/Timeout.js
/**
...
function Timeout_Timeout() {
  return /*#__PURE__*/external_React_default().createElement("div", {
    ...
    className: "icon icon-hourglass-bottom"
  })));
}
;// ./src/components/import-key/ImportKey.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['form_cancel', 'form_confirm', 'key_import_default_description', 'key_import_default_headline', 'key_import_invalidated_description', 'key_import_rotation_add', 'key_import_rotation_cancel', 'key_import_rotation_description', 'key_import_rotation_headline', 'keygrid_key_fingerprint', 'keygrid_keyid', 'keygrid_user_email', 'keygrid_user_name', 'keyring_confirm_keys']);
const TIMEOUT = 22000; // 22s

class ImportKey extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      waiting: true,
  ...
  render() {
    ...
    }, this.state.rotation ? map.key_import_rotation_headline : map.key_import_default_headline)), /*#__PURE__*/external_React_default().createElement("div", {
      className: "modal-body overflow-auto py-0 px-4"
    }, !this.state.rotation && /*#__PURE__*/external_React_default().createElement("p", null, !this.state.invalidated ? map.key_import_default_description : get('key_import_invalidated_description', [this.state.key.email ? this.state.key.email : this.state.key.name])), !this.state.showError ? /*#__PURE__*/external_React_default().createElement("div", {
      className: "table-responsive"
    }, /*#__PURE__*/external_React_default().createElement("table", {
      className: "table table-custom"
    }, /*#__PURE__*/external_React_default().createElement("thead", null, /*#__PURE__*/external_React_default().createElement("tr", null, /*#__PURE__*/external_React_default().createElement("th", null), /*#__PURE__*/external_React_default().createElement("th", null, map.keygrid_keyid), /*#__PURE__*/external_React_default().createElement("th", null, map.keygrid_user_name), /*#__PURE__*/external_React_default().createElement("th", null, map.keygrid_user_email), /*#__PURE__*/external_React_default().createElement("th", null, map.keygrid_key_fingerprint))), /*#__PURE__*/external_React_default().createElement("tbody", null, this.state.key.users.map((user, userIndex) => /*#__PURE__*/external_React_default().createElement("tr", {
      key: userIndex,
      tabIndex: "0",
      "aria-haspopup": "true",
    ...
    }, userIndex === 0 && /*#__PURE__*/external_React_default().createElement("span", {
    ...
    }, userIndex === 0 ? this.state.key.keyId : ''), /*#__PURE__*/external_React_default().createElement("td", {
      className: `align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, user.name), /*#__PURE__*/external_React_default().createElement("td", {
      className: `align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, user.email), /*#__PURE__*/external_React_default().createElement("td", {
      style: {
        maxWidth: '180px'
      },
      className: `monospaced text-muted small text-break align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, userIndex === 0 ? formatFpr(this.state.key.fingerprint) : '')))))) : /*#__PURE__*/external_React_default().createElement(Alert, {
      header: this.state.error.header,
      type: this.state.error.type
    }, this.state.error.message), this.state.rotation && /*#__PURE__*/external_React_default().createElement("p", null, map.key_import_rotation_description)), /*#__PURE__*/external_React_default().createElement("div", {
    ...
    }, this.state.rotation ? map.key_import_rotation_cancel : map.form_cancel), /*#__PURE__*/external_React_default().createElement("button", {
      type: "button",
      onClick: this.handleConfirm,
      className: "btn btn-primary"
    }, this.state.rotation ? map.key_import_rotation_add : map.keyring_confirm_keys))))))), this.state.timeout && /*#__PURE__*/external_React_default().createElement(Timeout_Timeout, null));
  }
}
ImportKey.propTypes = {
  id: (prop_types_default()).string,
  isContainer: (prop_types_default()).bool
};
;// ./src/components/import-key/importKeyRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(ImportKey, {
    id: id
