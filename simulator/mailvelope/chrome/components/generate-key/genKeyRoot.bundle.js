...
"use strict";
/*!****************************************************************!*\
  !*** ./src/components/generate-key/genKeyRoot.js + 16 modules ***!
  \****************************************************************/
...
class DefinePassword extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordCheck: ''
  ...
  render() {
    ...
    }, map.key_gen_pwd), /*#__PURE__*/external_React_default().createElement("input", {
    ...
    }), this.props.errors.password && /*#__PURE__*/external_React_default().createElement("div", {
      className: "invalid-feedback"
    }, this.props.errors.password.message !== '' ? this.props.errors.password.message : map.key_gen_pwd_empty)), /*#__PURE__*/external_React_default().createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/external_React_default().createElement("label", {
      htmlFor: "passwordCheck",
      className: this.props.hideLabels ? 'sr-only' : ''
    }, map.key_gen_pwd_reenter), /*#__PURE__*/external_React_default().createElement("input", {
    ...
    }), this.props.errors.passwordCheck && /*#__PURE__*/external_React_default().createElement("div", {
      className: "invalid-feedback"
...
DefinePassword.propTypes = {
  ...
  hideLabels: (prop_types_default()).bool
};
...
;// ./src/components/generate-key/GenKey.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class GenKey extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      password: '',
  ...
  render() {
    ...
    }, this.state.waiting ? /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement(Spinner_Spinner, {
      style: {
        margin: '10px auto 20px auto'
      }
    }), /*#__PURE__*/external_React_default().createElement("h4", {
      className: "align-self-center text-center"
    }, map.keygen_waiting_headline), /*#__PURE__*/external_React_default().createElement("p", {
      className: "align-self-center text-center mb-0"
    }, map.keygen_waiting_description)) : /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement("h4", {
      className: "mb-4"
    }, map.keygen_dialog_prolog), /*#__PURE__*/external_React_default().createElement(DefinePassword, {
...
function init() {
  ...
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(GenKey, {
    id: id
