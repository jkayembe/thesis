...
"use strict";
/*!*******************************************************************!*\
  !*** ./src/components/auth-domain/authDomainRoot.js + 15 modules ***!
  \*******************************************************************/
...
register(['auth_domain_api_label', 'auth_domain_headline', 'form_cancel', 'form_confirm', 'form_no', 'form_yes', 'watchlist_title_frame']);
class AuthDomain extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.state = {
      waiting: true,
  ...
  render() {
    return /*#__PURE__*/external_React_default().createElement(SecurityBG_SecurityBG, {
    ...
    }, map.auth_domain_headline)), /*#__PURE__*/external_React_default().createElement("div", {
      className: "modal-body overflow-auto py-0 px-4"
    }, this.state.frame && /*#__PURE__*/external_React_default().createElement((external_React_default()).Fragment, null, /*#__PURE__*/external_React_default().createElement("p", null, get('auth_domain_description', [this.state.frame.hostname])), /*#__PURE__*/external_React_default().createElement("dl", {
      className: "row d-flex align-items-center mb-0"
    }, /*#__PURE__*/external_React_default().createElement("dt", {
      className: "col-4 mb-2"
    }, map.watchlist_title_frame), /*#__PURE__*/external_React_default().createElement("dd", {
      className: "col-8"
    }, this.state.frame.urlPattern), /*#__PURE__*/external_React_default().createElement("dt", {
      className: "col-4 mb-2"
    }, map.auth_domain_api_label), /*#__PURE__*/external_React_default().createElement("dd", {
      className: "col-8"
    }, /*#__PURE__*/external_React_default().createElement("span", {
      ...
      "aria-hidden": "true"
    }), " ", this.state.frame.api ? map.form_yes : map.form_no))))), /*#__PURE__*/external_React_default().createElement("div", {
    ...
    }, map.form_confirm))))))), this.state.timeout && /*#__PURE__*/external_React_default().createElement(Timeout_Timeout, null));
  }
}
...
function init() {
  ...
  external_ReactDOM_default().render(/*#__PURE__*/external_React_default().createElement(AuthDomain, {
    id: id
